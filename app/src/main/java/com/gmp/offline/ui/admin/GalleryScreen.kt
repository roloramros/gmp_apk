...
fun GalleryScreen(onBack: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { if (searchVisible) SearchField(searchQuery, { searchQuery = it }) else Text("Galería") },
                navigationIcon = {
        ...
        GalleryTabContent(searchQuery = searchQuery, modifier = Modifier.padding(padding))
    }
}
